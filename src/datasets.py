...
class GenotypeDataset(Dataset):
    def __init__(self, args):
        ...
        # load labels 
        self.label_df = pd.read_csv(args.train, sep='\t', header=None, names=['cell_line', 'smiles', 'auc', 'dataset'])
...
class UKBGeneLevelDataset(Dataset):
    def __init__(self, args):
        ...
        self.gene_id_mapping = {gene: idx for idx, gene in zip(self.gene_df.index, self.gene_df["gene_name"])}
