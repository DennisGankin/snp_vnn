...
class TrainingDataWrapper():
	...
	def __init__(self, args):
		...
		self.input_features = np.dstack([self.mutations, self.cn_deletions, self.cn_amplifications])
...
class TrainingDataWrapperGeno():
	...
	def prepare_train_data(self):
		return util.prepare_train_data(self.train, self.sample_id_mapping, self.zscore_method, self.std)
